...
public class Main {
	...
	public static String fetchQuestionDesc51(String questionCode, Connection siConnection) throws SQLException {
	...
	public static String fetchQuestionDesc10(String questionCode, Connection siConnection) throws SQLException {
		PreparedStatement pStmt = null;
		ResultSet rs = null;
		int index = 0;
		String questDesc = null;
	...
	public static String fetchQuestionDesc8(String questionCode, Connection siConnection) throws SQLException {
		PreparedStatement pStmt = null;
		ResultSet rs = null;
		int index = 0;
		String questDesc = null;
